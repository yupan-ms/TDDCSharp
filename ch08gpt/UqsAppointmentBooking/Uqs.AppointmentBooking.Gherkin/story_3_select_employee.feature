...
Feature: Appointment Booking
  As a customer
  I want to select an employee
  So that I can book an appointment with my favorite barber

  @feature-example
  Scenario Outline: Select an employee
    ...
    Then the employee "<employee>" should be selected
